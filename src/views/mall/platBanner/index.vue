...
import { getBannerDetail, deleteBanner, queryBannerList, createBannerWithFile, updateBannerWithFile } from '@/api/mall/platBanner'
...
function handleCreateConfirm() {
  ...
  createBannerWithFile(file).then(res => {
...
function handleEditConfirm() {
  ...
  updateBannerWithFile(editForm.value.id.toString(), file).then(() => {
